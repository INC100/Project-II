...
from DiscussionModel import Discriminator, Variant_Upsampling
...
g.load_state_dict(torch.load(filepath + 'TransGenerator_170.pth'))
m_d.load_state_dict(torch.load(filepath + 'MrDiscriminator_170.pth'))
p_d.load_state_dict(torch.load(filepath + 'PetDiscriminator_170.pth'))
...
epoches = 200
for epoch in range(171, epoches + 1):
